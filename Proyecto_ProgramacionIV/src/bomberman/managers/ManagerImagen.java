...
/**
 * Clase que se encargará de devolver y guardar las imágenes.
 * @author David
 * @version 1.0
 */
public class ManagerImagen {

	//HashMap que almacenará las imágenes
	private static HashMap<String, BufferedImage> sprites = cargarImagenes();

	/**
	 * Se encarga de cargar todas las imágenes de la BD y meterlas en el HashMap
	 * 
