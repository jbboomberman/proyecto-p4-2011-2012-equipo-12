...
public class Bomberman extends SpriteDinamico {
	...
	public Bomberman(Escenario esce) {
		...
		velocidad = 150;
		parado = false;
		spritesImagUp = new String [] {"bomber.gif_9", "bomber.gif_10", "bomber.gif_11"};
		spritesImagDown = new String [] {"bomber.gif_13", "bomber.gif_14", "bomber.gif_15"};
		spritesImagRight = new String [] {"bomber.gif_5", "bomber.gif_6", "bomber.gif_7"};
		spritesImagLeft = new String [] {"bomber.gif_1", "bomber.gif_2", "bomber.gif_3"};
