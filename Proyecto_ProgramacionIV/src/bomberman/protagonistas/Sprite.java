...
/**
 * Clase que representa a todos los personajes del juego.
 * De ella heredan varias clases.
 * @author David
 * @version 1.0
 */
public class Sprite {
	 ...
	 * cuando el Sprite está vivo.
	 */
	protected String[] spritesImag;
	/*
	 * Array con los nombres de las imagenes
	 * cuando el Sprite se está muriendo.
	 */
	protected String[] spritesImagDest;
	/*
	 * Número de la imagen que se está
	 * viendo en pantalla.
	 */
	 ...
	 * @param esce - Escenario, donde se pintará
	 * @param jug - Jugador, el propietario
	 */
	...
	/**
	 * Devuelve un array con objetos de la
	 * clase String con los nombres de las
	 * imágenes utilizadas cuando el Sprite
	 * está vivo.
	...
	/**
	 * Para modificar el array con objetos
	 * de la clase String con los nombres de
	 * las imágenes utilizadas cuando el Sprite
	 * está vivo.
	 * También calcula la anchura y altura del
	 * Sprite según las medidas más grandes de
	 * las imagenes.
	 * @param spritesImag - String[]
	 */
	...
	/**
	 * Devuelve el número de imagen utilizada
	 * actualmente.
	...
	/**
	 * Modifica el número de imagen que se
	 * está utilizando.
	 * @param imagActual - int
	 */
	...
	/**
	 * Para modificar el estado del Sprite.
	 * Destrucción - No destrucción
	 * @param seDestruir - boolean
	 */
	...
	/**
	 * Devuelve al array con los nombres
	 * de las imagenes de destrucción.
	...
	/**
	 * Modifica el array con los nombres
	 * de las imagenes de destrucción.
	 * @param nom - String[]
	 */
	...
	/**
	 * Sirve para pintar el Sprite en la pantalla.
	...
	public void paint(Graphics2D g) {
		...
		/*
		 * En caso de que todavía no lo hayamos pintado
		 * ninguna vez tendremos que decirle que el tiempo
		 * transcurrido es mayor que 0.01F.
		 */
	...
	/**
	 * Este método cambia las imagenes del personaje
	 * para que parezca que tiene vida propia.
	 * OJO, no se mueve de posición sino que
	 * modifica las imagenes del Sprite para
	 * darle vida.
	 */
	public void mover() {
		t++;
		...
		if (t % velocidadPic == 0 && !seDestruir) {
			...
			/*
			 * En caso de que se tenga que destruir
			 * mostramos las imágenes de la muerte.
			 */
			t = 0;
...
//PUESE SER INTERESANTE
	...
	/**
	 * Método que se encarga de eliminar el Sprite
	 * del escenario.
	 */
	...
	/**
	 * Devuelve un objeto de la clase Rectangle con la
	 * anchura, altura y posición del Sprite.
	 * @return Rectangle
	 */
	public Rectangle getRectangle(Sprite spr){
		Rectangle tempRect;
		/*
		 * En caso de que sea de la clase Bomberman solo tendremos en cuenta
		 * la parte de abajo del personajes ya que se supone que su cabeza
		 * no toca el suelo. 
		 */
	...
	/**
	 * Devuelve un objeto de la clase Rectangle pero desde
