...
public class VentanaInicial extends JFrame implements ActionListener{
	...
	public VentanaInicial()
	{
		...
		/*
		 * Creamos un objeto de tipo PanelpfFondo que hará que se vea una imagen en el pfFondo de la pantalla.
		 */
		...
		/*
		 * Modificamos las características del título para que tenga un buen aspecto.
		 */
		...
		/*
		 * A cada botón le añadimos un escuchador, al ser 'addActionListener' le añadirá el
		 * escuchador más típico, la propia ventana.
		 */
		...
		/*
		 * Queremos que cuando la ventana se cierre el programa entero termine su ejecución.
		 */
		this.addWindowListener(new WindowAdapter(){
			public void windowClosing(WindowEvent e){
				/*
				 * En caso de que escuche un evento para cerrar la ventana
				 * le diremos que acabe la ejecución del programa entero.
				 */
				System.exit(0);
			}
		});
	...
	{
		/*
		 * Para saber dónde se originó el evento creamos un Object con la dirección del
		 * generador del evento.
		 */
		Object botonpulsado = e.getSource();
		
		//En caso de que el botón pulsado sea 'jbBotonJugar'.
...
//		}
//		
//		//En caso de que el botón pulsado sea 'jbBotonPuntu'.
...
//		}
//		
//		//En caso de que el botón pulsado sea 'jbBotonInstruc'.
...
//		}
		...
		//En caso de que el botón pulsado sea 'jbBotonSobre'.
...
//		}
	...
	/**
	 * Con este método logramos meter los componentes de una forma ordenada y centrada.
	 */
	...
	/**
	 * Este es el método main que nos sirve para comprobar que
