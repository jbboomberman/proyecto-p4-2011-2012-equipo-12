...
/**
 * Clase que Bomba que representa a la bombas
 * que pone el personaje principal.
 * @author David
 * @version 1.0
 */
public class Bomba extends SpriteEstatico {
	...
	public Bomba(Escenario esce, float x, float y, Bomberman bomber,
		...
		/*
		 * El temporador tendrá 3 segundos y cuando los
		 * alcance explotará la bomba.
		 */
		temporizador.schedule(new CargarExplosion(), 3000);
	}

	/**
	 * Sobreescribimos el método pintar para
	 * saber si el Bomberman ha dejado de pisar
	 * la bomba.
	 */
	...
	/**
	 * Modificar el parámetro para
	 * que pueda ser pisada.
	 * @param pisada - boolean
	 */
	...
	/**
	 * Cuando el temporizador acabe se ejecutará
	 * el método run().
	 * @author David
	 * @version 1.0
	 */
	...
	/**
	 * Calcula la distancia que pueden recorrer las
	 * llamas en cada lado.
	 * @return int[] - La distancia que pueden
	 * recorrer las llamas en cada lado.
	 */
	 ...
	 * @param distancias - int[] - Las distancias a las que puede llegar.
	 */
	public void colocarLlamas(int[] distancias) {
		...
		/*
		 * Arriba, creamos las llamas que vayan hacia
		 * arriba pero sin ser la última.
		 */
		...
		/*
		 * Abajo, creamos las llamas que vayan hacia
		 * abajo pero sin ser la última.
		 */
		...
		/*
		 * Derecha, creamos las llamas que vayan hacia
		 * derecha pero sin ser la última.
		 */
		...
		/*
		 * Izquierda, creamos las llamas que vayan hacia
		 * izquierda pero sin ser la última.
		 */
