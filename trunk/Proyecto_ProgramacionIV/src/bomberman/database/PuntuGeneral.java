...
public class PuntuGeneral implements Comparable<PuntuGeneral>{
	 ...
	 * (Código del jugador), GUARDADO (Valor booleano para saber si es de tipo
	 * guardado o no), PUNTU (Puntuación) y FECHA_ULTI_NIVEL (La fecha en la que
	 * se obtuvo esa puntuación). Tendrá un constructor en el que deberá recibir
	 * todos estos parámetros y getters y setters de todos los parámetros.
	 */
